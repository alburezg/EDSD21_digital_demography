...
<!-- ![Why so many men?](resources/pyramid.PNG){width=300px} -->
...
![Weighted mortality rates](resources/familinx_corrected.PNG){width=350px}


\tiny Chong, Alburez-Gutierrez, Del Fava, Alexander, Zagheni (2021). Identifying and correcting bias in big crowd-sourced online genealogies. 
